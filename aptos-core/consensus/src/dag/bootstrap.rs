...
use gaptos::aptos_channels::{
    gaptos::aptos_channel::{self, Receiver},
...
pub(super) fn bootstrap_dag_for_test(
    ...
    JoinHandle<()>,
    gaptos::aptos_channel::Sender<Author, IncomingDAGRequest>,
    ...
    let (dag_rpc_tx, dag_rpc_rx) = gaptos::aptos_channel::new(QueueStyle::FIFO, 64, None);
