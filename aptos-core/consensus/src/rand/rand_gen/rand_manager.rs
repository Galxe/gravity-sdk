...
impl<S: TShare, D: TAugmentedData> RandManager<S, D> {
    ...
    async fn verification_task(
        epoch_state: Arc<EpochState>,
        mut incoming_rpc_request: gaptos::aptos_channel::Receiver<Author, IncomingRandGenRequest>,
    ...
    pub async fn start(
        ...
        incoming_rpc_request: gaptos::aptos_channel::Receiver<Author, IncomingRandGenRequest>,
