...
impl BufferManagerHandle {
    ...
    pub fn init(
        ...
        commit_tx: gaptos::aptos_channel::Sender<AccountAddress, IncomingCommitRequest>,
...
impl ExecutionProxyClient {
    ...
    fn spawn_decoupled_execution(
        ...
        let (commit_msg_tx, commit_msg_rx) =
            gaptos::aptos_channel::new::<AccountAddress, IncomingCommitRequest>(
                QueueStyle::FIFO,
                100,
...
impl TExecutionClient for DummyExecutionClient {
    async fn start_epoch(
        ...
        _rand_msg_rx: gaptos::aptos_channel::Receiver<AccountAddress, IncomingRandGenRequest>,
