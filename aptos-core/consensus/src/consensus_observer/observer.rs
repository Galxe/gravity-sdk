...
use gaptos::aptos_consensus_types::{pipeline, pipelined_block::PipelinedBlock};
...
impl ConsensusObserver {
    ...
    async fn wait_for_epoch_start(&mut self) {
        ...
        let (_, rand_msg_rx) =
            gaptos::aptos_channel::new::<AccountAddress, IncomingRandGenRequest>(QueueStyle::FIFO, 1, None);
