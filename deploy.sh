rm -rf node1/data/consensus_db
rm -rf node1/data/quorumstoreDB
rm -rf node1/data/rand_db

rm -rf node2/data/quorumstoreDB
rm -rf node2/data/consensus_db
rm -rf node2/data/rand_db
