...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::gaptos::aptos_logger::Value::from_serde };
    let from_display = quote! { ::gaptos::aptos_logger::Value::from_display };
    let from_debug = quote! { ::gaptos::aptos_logger::Value::from_debug };
    let key_new = quote! { ::gaptos::aptos_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::gaptos::aptos_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::gaptos::aptos_logger::Visitor) {
                #(#visits)*
            }
        }
    };
