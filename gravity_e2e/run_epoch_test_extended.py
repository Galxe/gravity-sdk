#!/usr/bin/env python3
"""
独立运行 epoch_consistency_extended 测试的脚本
...
async def main():
    """运行测试"""
    LOG.info("=" * 70)
    LOG.info("Running Epoch Consistency Extended Test (Standalone)")
    LOG.info("=" * 70)
    ...
    try:
        ...
        test_result = await test_epoch_consistency_extended(run_helper=run_helper)
