...
class TransactionBuilder:
    ...
    async def get_nonce(self, refresh: bool = False) -> int:
        ...
        try:
            ...
            pending_count = await self.retry.execute(
    ...
    async def estimate_gas(
        ...
        try:
            ...
            # Estimate gas
            gas_estimate = await self.retry.execute(
    ...
    async def build_transaction(
        ...
        **kwargs
        ...
        if opts.chain_id:
            ...
            # Get from network
            try:
                chain_id = await self.retry.execute(self.web3.eth.chain_id)
                tx['chainId'] = chain_id
            except Exception as e:
        ...
        if opts.tx_type == 2 or (opts.tx_type is None and opts.max_fee_per_gas):
            ...
            if opts.gas_price:
                ...
                try:
                    gas_price = await self.retry.execute(self.web3.eth.gas_price)
    ...
    async def send_transaction(
        ...
        try:
            ...
            tx_hash = await self.retry.execute(
